    ...
    case 0x0507: // Media Input Cluster
    {
        ...
        switch (am->attributeId)
        {
            case 0x0000: // media input list
            {
                ...
                entryOffset = static_cast<uint16_t>(entryOffset + 34);
                ByteSpan descriptionSpanStorage(Uint8::from_const_char(entry->description.data()), entry->description.size()); // CHAR_STRING
    ...
    case 0x0504: // TV Channel Cluster
    {
        ...
        switch (am->attributeId)
        {
            case 0x0000: // tv channel list
            {
                ...
                entryOffset = static_cast<uint16_t>(entryOffset + 34);
                ByteSpan affiliateCallSignSpanStorage(Uint8::from_const_char(entry->affiliateCallSign.data()), entry->affiliateCallSign.size()); // CHAR_STRING
